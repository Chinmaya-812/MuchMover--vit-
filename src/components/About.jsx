import Poster from "../assets/img/11.jpg";
              ...
              <div className=" relative ">
                ...
                <div className="lg:max-w-xl lg:pr-5 relative z-40">
                  ...
                  <p className="text-base text-gray-700">
                    At Crispy Bytes, were not just about satisfying your
                    hunger; were here to ignite your passion for flavor
                    exploration. Our web application brings together a diverse
                    array of restaurants, each offering their own unique tastes
                    and specialties, all within easy reach of your fingertips.
                  </p>
                  <div className="mt-10 flex flex-col items-center md:flex-row">
                    ...
                    <a
                      href="https://www.linkedin.com/in/chinmaya-nimalpuri/"
                      target="_blank"
